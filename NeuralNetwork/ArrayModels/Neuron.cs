...
namespace NeuralNetwork.ArrayModels
{
    ...
    public class Neuron
    {
        ...
        internal List<Connection> Inputs { get; } = new();
        internal List<Connection> Outputs { get; } = new();
        internal double PreActivatedOutput { get; private set; }
        internal double PostActivatedOutput { get; set; }
        internal double InputZ { get => PreActivatedOutput; set => PreActivatedOutput = value; }
        internal double OutputA { get => PostActivatedOutput; set => PostActivatedOutput = value; }
        ...
        public override string ToString() => $"Neuron {Id} Z: {InputZ:0.00} b: {Bias:0.00} A: {OutputA:0.00} Error: {Error:0.00}";
    }
}